...
set SCADE_INSTALL=C:\Program Files\ANSYS Inc\v261\SCADE
...
if not exist "graphics\DF\UA_1.bin" (
    ...
    "%SCADE_INSTALL%\SCADE A661\DFGEN681\bin\dfgen.exe" ^
...
if not exist %VENV% (
    ...
    "%SCADE_INSTALL%\contrib\Python312\python.exe" -m venv %VENV%
