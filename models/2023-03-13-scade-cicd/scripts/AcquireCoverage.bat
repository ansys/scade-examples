...
if exist "%SCADE_DIR%\contrib\Python37\python.exe"  set PYTHON_EXE=%SCADE_DIR%\contrib\Python37\python.exe
if exist "%SCADE_DIR%\contrib\Python310\python.exe" set PYTHON_EXE=%SCADE_DIR%\contrib\Python310\python.exe
if exist "%SCADE_DIR%\contrib\Python312\python.exe" set PYTHON_EXE=%SCADE_DIR%\contrib\Python312\python.exe
@echo SCADE dir: %SCADE_DIR%
